  ...
  <Layout>
    <Container className="flex flex-col">
      ...
      <Text>
          ...
          sur la <a href="https://bdrp.ch" target="_blank">Banque de Ressources Pédagogiques (BDRP)</a>,
	  ...
	  Une discussion entre l'équipe de modération et l'auteur-ice de la ressource aura lieu concernant d'éventuelles adaptation
