...
\newenvironment{exercise}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraviolet, colback=llgray, boxrule=2pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{solution}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraturquoise, colback=llgray, boxrule=2pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{microactivity}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=darkspringgreen, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{togofurther}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=darkviolet, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{important}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=red, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{didyouknow}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=babyblue, colback=llgray, boxrule=1.5pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{reminder}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=orange, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{related}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=brightturquoise, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{evaluation}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=darkspringgreen, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{thinkingmatter}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=beaublue, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{note}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=carolinablue, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{torecall}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=red, colback=llgray, boxrule=2pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{historicdocument}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, colframe=lapislazuli, colback=llgray, boxrule=2pt]\sphinxstrong{#1}}{\end{tcolorbox}}
...
% légende d'images
\usepackage[width=.8\textwidth, font=small, labelfont=bf]{caption}
\DeclareCaptionFont{nohyphen}{\hyphenpenalty=10000 \exhyphenpenalty=10000\relax}
\captionsetup{font+=nohyphen, aboveskip=8pt, belowskip=8pt}
