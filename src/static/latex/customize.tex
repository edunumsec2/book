...
\DeclareGraphicsAlien{.gif}{.pdf}{sips -s format pdf  '\SourceFile[0]' --out \OutputFile}%
\DeclareGraphicsAlien{.svg}{.pdf}{%
    /Applications/Inkscape.app/Contents/MacOS/inkscape --export-type=pdf --export-area-page '\SourceFile' -o '\OutputFile' 2>/dev/null}%
