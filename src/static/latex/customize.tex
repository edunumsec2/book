...
\usepackage{answers} %% for putting solutions in the end
...
%% putting solutions at the end of chapter
\Newassociation{solution}{Soln}{solutions}
\Opensolutionfile{solutions}[ans0]
\renewenvironment{Soln}[1]{\par\textbf{#1}}{}
\AtEndDocument{\Closesolutionfile{solutions}\newpage\section{Solutions des exercices}\input{ans0}}
