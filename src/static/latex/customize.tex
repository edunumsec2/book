...
\newenvironment{microactivity}[1]{\begin{tcolorbox}[colframe=green]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{togofurther}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{important}[1]{\begin{tcolorbox}[colframe=red]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{didyouknow}[1]{\begin{tcolorbox}[colframe=carolinablue, colback=llgray, boxrule=2pt]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{reminder}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{related}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{evaluation}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{thinkingmatter}[1]{\begin{tcolorbox}[colframe=carolinablue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{note}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{torecall}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
\newenvironment{historicdocument}[1]{\begin{tcolorbox}[colframe=blue]\sphinxstrong{#1}}{\end{tcolorbox}}
...
\makeatletter
  ...
  % page of a chapter `clean.'
   \fancypagestyle{plain}{
    ...
    \if@twoside\fancyfoot[CE]{{\py@HeaderFamily \mdseries \thepage}}\fi
