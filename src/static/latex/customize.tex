...
\definecolor{llgray}{rgb}{0.96, 0.96, 0.96}
...
% TODO: this is a problem with page breaks, we may want to use activitybox instead
% (cf. https://tex.stackexchange.com/questions/350316/create-manual-page-break-within-tcolorbox)
\newenvironment{exercise}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraviolet, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{3pt}}
\newenvironment{solution}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraturquoise, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{microactivity}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraviolet, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{togofurther}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=orangemodulo, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{important}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=radicalred, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{didyouknow}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=orangemodulo, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{reminder}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=radicalred, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{related}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=neoncarrot, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{evaluation}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=radicalred, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{thinkingmatter}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=ultraviolet, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{note}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=neoncarrot, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{torecall}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=radicalred, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
\newenvironment{historicdocument}[1]{\vspace{3pt}\begin{tcolorbox}[fontupper=\fontfamily{phv}, colframe=neoncarrot, colback=llgray, boxrule=1pt, top=8pt, left=8pt, right=28pt, bottom=8pt]\sphinxstrong{#1}}{\end{tcolorbox}\vspace{12pt}}
...
\setlength{\headheight}{16.59999pt}
