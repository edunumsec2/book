...
\newenvironment{evaluation}[1]{\begin{tcolorbox}[fontupper=\fontfamily{phv}, parbox=false, colframe=darkgreen, colback=llgray, boxrule=1pt]\sphinxstrong{#1}}{\end{tcolorbox}}
