...
{ // JSON5
  ...
  opts: {wireStyle: 'vh'},
  components: {
    in0: {type: 'in', pos: [100, 195], orient: 's', id: 3, name: 'A3'},
    in1: {type: 'in', pos: [200, 195], orient: 's', id: 0, name: 'A2'},
    in2: {type: 'in', pos: [300, 195], orient: 's', id: 1, name: 'A1'},
    in3: {type: 'in', pos: [400, 195], orient: 's', id: 2, name: 'A0'},
    in4: {type: 'in', pos: [140, 45], orient: 's', id: 15, name: 'B3'},
    in5: {type: 'in', pos: [240, 45], orient: 's', id: 14, name: 'B2'},
    in6: {type: 'in', pos: [340, 45], orient: 's', id: 13, name: 'B1'},
    in7: {type: 'in', pos: [440, 45], orient: 's', id: 12, name: 'B0'},
