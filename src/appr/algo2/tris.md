...
```{admonition} Exercice 3.1. Complexité du Tri par insertion
:class: note
...
````{admonition} Solution 3.1. Complexité du Tri par insertion
:class: hint
...
```{admonition} Exercice 3.2. Complexité du Tri à bulles
:class: note
...
````{admonition} Solution 3.2. Complexité du Tri à bulles
:class: hint
...
```{admonition} Exercice 3.3. Le pire du Tri rapide
:class: note
...
````{admonition} Solution 3.3. Le pire du Tri rapide
:class: hint
...
```{admonition} Exercice 3.4. Le meilleur et le pire du Tri par insertion
:class: note
...
````{admonition} Solution 3.4. Le meilleur et le pire du Tri par insertion
:class: hint
