...
# ones.
sys.path.append(os.path.abspath("../../source/extensions/codeplay"))
sys.path.append(os.path.abspath("../../source/extensions/glossary"))
sys.path.append(os.path.abspath("../../source/extensions/questions"))
sys.path.append(os.path.abspath("../../source/extensions/videos"))
extensions = [
    'codeplay',
    'glossary',
    'myst_parser',
