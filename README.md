...
- [**Apprendre**](https://apprendre.modulo-info.ch/): qui propose des ressources didactives à la destination des **élèves** (Représentation de l'information, Programmation, Algorithmique, Architecture des ordinateurs, Réseaux, Histoire de l'informatique)
